...
u.population 	= 5
u.spawn_time 	= 80
u.description 	= [[Static assault weapon that fires a beam of energy at targets resulting in an explosion after some time. Can be manually targeted with force-target, or set to automatically target nearby buildings by pressing E on it. Requires 5000 energy to fire.]]
...
u.population 	= 3
u.spawn_time 	= 25
u.description 	= [[A Full defence tower that zaps and destroys incoming projectiles. Consumes 50 energy per projectile destroyed.]]
...
u.population 	= 0
u.spawn_time 	= 2
u.description 	= [[Solar panels produce 5 energy every 5 seconds. They lose efficiency if the sky is obstructed.]]
