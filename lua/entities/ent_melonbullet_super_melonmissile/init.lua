...
function ENT:Explode()
	...
	for k, v in pairs( player.GetAll() ) do
		...
		/*local MWColourModifierTable = {
			...
			[ "$pp_colour_addg" ] = 0.0,
			[ "$pp_colour_addb" ] = 0.0,
			[ "$pp_colour_brightness" ] = 0-10/i,
			[ "$pp_colour_contrast" ] = 10/i,
			[ "$pp_colour_colour" ] = 1-10/i,
			[ "$pp_colour_mulr" ] = -0.5,
			[ "$pp_colour_mulg" ] = 0.5,
			[ "$pp_colour_mulb" ] = -0.5
		}*/
		...
		for i=1, 100 do
			timer.Simple( i/20, function()
				MWColourModifierTable = {
					...
					[ "$pp_colour_addg" ] = 0,
					[ "$pp_colour_addb" ] = 0,
					[ "$pp_colour_brightness" ] = 0-15/i, 
					[ "$pp_colour_contrast" ] = 1+5/i, 
					[ "$pp_colour_colour" ] = 1,
					[ "$pp_colour_mulr" ] = -10+i/10,
					[ "$pp_colour_mulg" ] = 5-i/20,
